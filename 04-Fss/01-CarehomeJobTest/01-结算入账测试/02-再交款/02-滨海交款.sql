...
VALUES ('2025-08051845',
        ...
        '0',
        NULL,
        'E0D67E6E-5EDF-4F40-8E7D-246E8462BF17',
        200);
-- 2. 创建一个柜面缴款信息
...
values ('250805184573', '2025-08051845', '20250805', '144200', 2000,
...
VALUES ('999920', 'batch_no:250805184573;', '20250508000001', '20201119', '1', '20250718095050', 'C', 12000.0, '0',
        'description 1');
...
VALUES ('E0D67E6E-5EDF-4F40-8E7D-246E8462BF17', 0, 0, '1', '20240329190902', 'auto', '测试12', '滨海新区');

delete
from PRESALE_MATE_WXZJ
where HOUSE_ID = 'E0D67E6E-5EDF-4F40-8E7D-246E8462BF11';
------------------------------------------------------------------------------------------------------------------------
select pay.batch_no,
       pay.buy_pact_no,
       pay.info_id,
