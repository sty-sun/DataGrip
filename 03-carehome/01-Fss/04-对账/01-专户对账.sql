...
(CFG_ID, ACCT_NO, SIDE_TYPE, ADJ_TYPE, ITEM_CODE, ITEM_NAME, DEFAULT_AMT, EFFECT_START_DATE, EFFECT_END_DATE, REASON, DISPLAY_ORDER, IS_DEL,
 CREATE_TIME, CREATE_USER, UPDATE_TIME, UPDATE_USER)
VALUES
    (6, '158001201110000869', 'B', 'S', 'BANK_PEND_AFTER_CR', '银行侧T0后贷方挂账', 0, '20251216', NULL, 'T0后挂账
  累计', 10, '0', SYSDATE, 'admin', NULL, NULL);

INSERT INTO FSS_DAILY_BAL_ADJ_ITEM_CFG
(CFG_ID, ACCT_NO, SIDE_TYPE, ADJ_TYPE, ITEM_CODE, ITEM_NAME, DEFAULT_AMT, EFFECT_START_DATE, EFFECT_END_DATE, REASON, DISPLAY_ORDER, IS_DEL,
 CREATE_TIME, CREATE_USER, UPDATE_TIME, UPDATE_USER)
VALUES
    (7, '158001201110000869', 'B', 'A', 'BANK_PEND_AFTER_DR', '银行侧T0后借方挂账', 0, '20251216', NULL, 'T0后挂账
  累计', 20, '0', SYSDATE, 'admin', NULL, NULL);

INSERT INTO FSS_DAILY_BAL_ADJ_ITEM_CFG
(CFG_ID, ACCT_NO, SIDE_TYPE, ADJ_TYPE, ITEM_CODE, ITEM_NAME, DEFAULT_AMT, EFFECT_START_DATE, EFFECT_END_DATE, REASON, DISPLAY_ORDER, IS_DEL,
 CREATE_TIME, CREATE_USER, UPDATE_TIME, UPDATE_USER)
VALUES
    (8, '158001201110000869', 'S', 'S', 'SYS_PEND_AFTER_CR', '系统侧T0后贷方挂账', 0, '20251216', NULL, 'T0后挂账
  累计', 30, '0', SYSDATE, 'admin', NULL, NULL);

INSERT INTO FSS_DAILY_BAL_ADJ_ITEM_CFG
(CFG_ID, ACCT_NO, SIDE_TYPE, ADJ_TYPE, ITEM_CODE, ITEM_NAME, DEFAULT_AMT, EFFECT_START_DATE, EFFECT_END_DATE, REASON, DISPLAY_ORDER, IS_DEL,
 CREATE_TIME, CREATE_USER, UPDATE_TIME, UPDATE_USER)
VALUES
    (9, '158001201110000869', 'S', 'A', 'SYS_PEND_AFTER_DR', '系统侧T0后借方挂账', 0, '20251216', NULL, 'T0后挂账
  累计', 40, '0', SYSDATE, 'admin', NULL, NULL);